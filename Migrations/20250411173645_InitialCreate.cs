        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empresas_Contadores_ContadorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistribuicoesLucro", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DistribuicoesLucro_Empresas_EmpresaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Observacoes_Empresas_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistribuicoesLucro_EmpresaId",
                table: "DistribuicoesLucro",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_Empresas_ContadorId",
                table: "Empresas",
                column: "ContadorId");

            migrationBuilder.CreateIndex(
                name: "IX_Observacoes_EmpresaId",
                table: "Observacoes",
                column: "EmpresaId");
